...
import com.github.frostbittenking.pgjdbcBugDemo.PGJDBCSQLContainer;
...
public class PostgreSQLContainerProvider extends JdbcDatabaseContainerProvider {
    ...
    public JdbcDatabaseContainer newInstance(String tag) {
        return new PGJDBCSQLContainer(DockerImageName.parse(PostgreSQLContainer.IMAGE).withTag(tag));
    }
